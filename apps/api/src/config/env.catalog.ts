...
export const ENVIRONMENT_VARIABLE_CATALOG: EnvironmentVariableSpec[] = [
  ...
  {
    name: 'INGEST_URL_TIMEOUT_MS',
    workspace: 'api',
    required: false,
    sensitive: false,
    description: 'Timeout for URL ingestion fetch operations in milliseconds.',
    exampleValue: '15000',
    defaultValue: '15000',
  },
  {
    name: 'MAX_PDF_CONCURRENCY',
    workspace: 'api',
    required: false,
    sensitive: false,
    description: 'Maximum concurrent PDF extraction jobs per API process.',
    exampleValue: '1',
    defaultValue: '1',
  },
  {
